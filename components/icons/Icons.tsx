...
export const GraduationCapSparkleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 10v6" />
        <path d="M2 10l10-5 10 5-10 5z" />
        <path d="M6 12v5c3.33 1.67 6.67 1.67 10 0v-5" />
        <path d="m19 2-1.25 2.75L15 6l2.75 1.25L19 10l1.25-2.75L23 6l-2.75-1.25Z"/>
    </svg>
);
...
export const TextIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M17 6.1H7" /><path d="M21 12.1H3" /><path d="M15 18.1H9" />
    </svg>
);

export const WandSparklesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m5 3-3 3 3 3" /><path d="m19 21 3-3-3-3" /><path d="M22 6 12 16l-4 4" /><path d="m2 18 10-10 4-4" /><path d="m15 6 3.4-3.4" /><path d="M9 18l-3.4 3.4" />
    </svg>
);
